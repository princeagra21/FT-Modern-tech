...
import { DisplayMap, SmartCheckboxAutoTable } from '../common/smartcheckboxautotable';
      ...
      <div className="p-3 max-w-xs">
        ...
        <div className="flex items-center gap-2 mb-2">
          <div className="w-8 h-8 bw-gradient-primary rounded-lg flex items-center justify-center bw-text-primary-fg font-semibold text-xs">
            {row.vehicleName.split(" ").slice(0, 2).map((n) => n[0]).join("").toUpperCase()}
          </div>
          <div>
            <div className="font-semibold bw-text-primary dark:text-neutral-100">{row.vehicleName}</div>
            <div className="text-xs bw-text-muted dark:text-neutral-400">{row.VehicleType} • {row.status}</div>
          </div>
        </div>
        ...
        <div className="space-y-1 text-xs">
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 bw-text-muted dark:text-neutral-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
            </svg>
            <span className="bw-text-primary dark:text-neutral-200 font-mono">{row.imei}</span>
          </div>
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 bw-text-muted dark:text-neutral-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
            </svg>
            <span className="bw-text-primary dark:text-neutral-200 font-mono">{row.vin}</span>
          </div>
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 bw-text-muted dark:text-neutral-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" />
            </svg>
            <span className="bw-text-primary dark:text-neutral-200">{row.DeviceType}</span>
          </div>
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 bw-text-muted dark:text-neutral-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span className="bw-text-primary dark:text-neutral-200">{row.GMT}</span>
          </div>
        </div>
        ...
        <div className="mt-2 pt-2 border-t bw-border dark:border-neutral-700">
          <div className="flex justify-between text-xs">
            <span className="bw-text-muted dark:text-neutral-400">Primary License:</span>
            <span className="font-medium bw-text-primary dark:text-neutral-200">{row.PrimaryExpiry}</span>
          </div>
          <div className="flex justify-between text-xs">
            <span className="bw-text-muted dark:text-neutral-400">Secondary License:</span>
            <span className="font-medium bw-text-primary dark:text-neutral-200">{row.SacendoryExpiry}</span>
          </div>
        </div>
  ...
  const displayOptions: DisplayMap<VehicleRow> = {
        ...
        <div className="flex items-center gap-3 min-w-[240px]">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 text-xs">
              <span className="bw-text-muted dark:text-neutral-400">{row.VehicleType}</span>
    ...
    1: {
      ...
      content: (row) => (
        <div className="space-y-1.5 min-w-[200px]">
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 bw-text-muted dark:text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
            </svg>
            <span className="font-mono text-xs bw-text-primary dark:text-neutral-200">{row.imei}</span>
          </div>
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 bw-text-muted dark:text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
            </svg>
            <span className="font-mono text-xs bw-text-muted dark:text-neutral-400">{row.vin}</span>
          </div>
          <div className="flex items-center gap-2">
        ...
        return (
          <div className="space-y-1.5">
            <div className="flex items-center gap-2">
              ...
              <div className="text-sm bw-text-primary dark:text-neutral-200">{date}</div>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-xs bw-text-muted dark:text-neutral-400">{time}</span>
              <span className="bw-text-muted dark:text-neutral-500">•</span>
              <span className="font-mono text-xs bw-text-muted dark:text-neutral-400">{row.GMT}</span>
            </div>
          </div>
        );
      },
    ...
    3: {
      ...
      content: (row) => {
        ...
        const getStatusIcon = (status: { isExpired: boolean; isExpiringSoon: boolean; daysUntilExpiry: number }) => {
          ...
          <div className="space-y-2 min-w-[180px]">
            ...
            <div className="px-3 py-2 rounded-lg border bw-border dark:border-neutral-700 bw-bg-secondary dark:bg-neutral-800">
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs font-medium bw-text-muted dark:text-neutral-400">Primary</span>
                <span className="text-sm bw-text-primary dark:text-neutral-300">{getStatusIcon(primary)}</span>
              </div>
              <div className="text-xs font-semibold bw-text-primary dark:text-neutral-200">{row.PrimaryExpiry}</div>
              {(primary.isExpired || primary.isExpiringSoon) && (
                <div className="text-xs font-medium mt-1 bw-text-muted dark:text-neutral-400">
                  {primary.isExpired ? "Expired" : `${primary.daysUntilExpiry}d left`}
                </div>
              )}
            </div>
            ...
            <div className="px-3 py-2 rounded-lg border bw-border dark:border-neutral-700 bw-bg-secondary dark:bg-neutral-800">
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs font-medium bw-text-muted dark:text-neutral-400">Secondary</span>
                <span className="text-sm bw-text-primary dark:text-neutral-300">{getStatusIcon(secondary)}</span>
              </div>
              <div className="text-xs font-semibold bw-text-primary dark:text-neutral-200">{row.SacendoryExpiry}</div>
              {(secondary.isExpired || secondary.isExpiringSoon) && (
                <div className="text-xs font-medium mt-1 bw-text-muted dark:text-neutral-400">
                  {secondary.isExpired ? "Expired" : `${secondary.daysUntilExpiry}d left`}
                </div>
              )}
            </div>
          </div>
  ...
  const bulkActions = [
    {
      ...
      callback: async (selectedRows: VehicleRow[], selectedIds: Set<string>) => {
    ...
    },
    {
      ...
      callback: async (selectedRows: VehicleRow[], selectedIds: Set<string>) => {
        if (confirm(`Are you sure you want to delete ${selectedRows.length} vehicle(s)?`)) {
    ...
    <div className="w-full max-w-full overflow-hidden">
                ...
                <div className="sticky top-0 z-30 border-b border-neutral-200 dark:border-neutral-700 bg-white/70 dark:bg-neutral-900/70 backdrop-blur-sm">
                  <div className="mx-auto max-w-7xl px-4 md:px-6 py-3 flex items-center justify-between">
                    <div>
                      <div className="text-[11px] uppercase tracking-[0.18em] text-neutral-500 dark:text-neutral-400">Vehicles</div>
                      <h1 className="text-2xl font-semibold tracking-tight dark:text-neutral-100">Vehicles List</h1>
                    </div>
     ...
     <div className="mx-auto max-w-7xl px-6 py-8">
      ...
      <div className="mb-5 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-2xl border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-800 p-4">
          <div className="mb-3 flex items-center gap-2">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-700">
              <DirectionsCarIcon className="dark:text-neutral-300" />
            </div>
            <div className="text-sm font-medium text-neutral-900 dark:text-neutral-200">Total Vehicles</div>
          </div>
          <div className="mb-1 text-2xl font-semibold text-neutral-900 dark:text-neutral-100">1,200</div>
          <div className="text-xs text-neutral-500 dark:text-neutral-400">currently tracked</div>
        </div>
        ...
        <div className="rounded-2xl border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-800 p-4">
          <div className="mb-3 flex items-center gap-2">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-700">
              <SignalCellularAltIcon className="dark:text-neutral-300" />
            </div>
            <div className="text-sm font-medium text-neutral-900 dark:text-neutral-200">Moving</div>
          </div>
          <div className="mb-1 text-2xl font-semibold text-neutral-900 dark:text-neutral-100">432</div>
          <div className="mt-2 inline-flex items-center rounded-full bg-neutral-900 dark:bg-white px-2 py-0.5 text-xs text-white dark:text-black">
            ▲ 3.8%
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-800 p-4">
          <div className="mb-3 flex items-center gap-2">
            ...
            <div className="text-sm font-medium text-neutral-900 dark:text-neutral-200">Idle</div>
          </div>
          <div className="mb-1 text-2xl font-semibold text-neutral-900 dark:text-neutral-100">215</div>
          <div className="mt-2 inline-flex items-center rounded-full bg-neutral-200 dark:bg-neutral-700 px-2 py-0.5 text-xs text-neutral-800 dark:text-neutral-300">
            ▼ 1.2%
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-800 p-4">
          <div className="mb-3 flex items-center gap-2">
            ...
            <div className="text-sm font-medium text-neutral-900 dark:text-neutral-200">Stopped</div>
          </div>
          <div className="mb-1 text-2xl font-semibold text-neutral-900 dark:text-neutral-100">190</div>
          <div className="mt-2 inline-flex items-center rounded-full bg-neutral-200 dark:bg-neutral-700 px-2 py-0.5 text-xs text-neutral-800 dark:text-neutral-300">
            ▼ 0.6%
          </div>
        </div>
...
function KpiCard({
  ...
  return (
    <div className="rounded-2xl border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-800 p-4">
      <div className="mb-3 flex items-center gap-2">
        <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-700">{icon}</div>
        <div className="text-sm font-medium text-neutral-900 dark:text-neutral-200">{title}</div>
      </div>
      ...
      {hasDelta && (
        <div
          className={classNames(
            ...
            isUp ? "bg-neutral-900 dark:bg-white text-white dark:text-black" : "bg-neutral-200 dark:bg-neutral-700 text-neutral-800 dark:text-neutral-300"
          )}
        >
