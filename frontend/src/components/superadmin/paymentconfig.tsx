    ...
    <div className="mx-auto max-w-7xl px-6 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredGateways.map((gateway) => {
          ...
          const isConfigured = Object.keys(config.credentials).some(
            (key) => config.credentials[key as keyof typeof config.credentials]
          );

          return (
            <Dialog
              key={gateway.id}
              open={selectedGateway === gateway.id}
              onOpenChange={(open) => {
            ...
            >
              <DialogTrigger asChild>
                <motion.div
                  ...
                  className={cn(
                    "rounded-2xl border border-border bg-background p-5 cursor-pointer transition-all hover:shadow-md hover:border-primary/40 dark:bg-foreground/5",
                  ...
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateConfig(gateway.id, { enabled: checked })
                      }
              ...
              <DialogContent className="rounded-2xl md:min-w-4xl max-h-[90vh] overflow-y-auto dark:bg-neutral-900 dark:border-neutral-700">
                ...
                <Tabs defaultValue="credentials" className="w-full mt-4">
                  <TabsList className="grid w-full grid-cols-3 mb-6 bg-background border border-border rounded-xl">
                    <TabsTrigger
                      value="credentials"
                  ...
                  <TabsContent value="credentials" className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        {(["sandbox", "production"] as Environment[]).map(
                          (env) => (
                            <button
                              key={env}
                              onClick={() =>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <Dialog>
                            ...
                            <DialogContent className="rounded-2xl bg-background border border-border">
                              <DialogHeader>
                                <DialogTitle className="flex items-center gap-2 text-foreground">
                                  <VerifiedUserIcon className="text-muted-foreground" />
                                ...
                                <DialogDescription className="space-y-3 pt-4 text-muted-foreground">
                                  ...
                                  <div>
                                    ...
                                    <ul className="text-xs mt-2 space-y-1 list-disc list-inside ml-2">
                                      ...
                                      <li>
                                        Secret management services (AWS Secrets
                          ...
                          >
                            {showSecrets[gateway.id] ? (
                              <>
                                <VisibilityOffIcon className="w-4 h-4 mr-1" />{" "}
                                Hide
                              </>
                            ) : (
                              <>
                      ...
                      {gateway.fields.map((field) => (
                        <div key={field}>
                          ...
                          <Input
                            ...
                            value={
                              config.credentials[
                                field as keyof typeof config.credentials
                              ] || ""
                            }
                            onChange={(e) =>
                              updateCredential(
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <Dialog>
                          ...
                          <DialogContent className="rounded-2xl bg-card border border-border">
                            <DialogHeader>
                              <DialogTitle className="flex items-center gap-2 text-foreground">
                              ...
                              <DialogDescription className="space-y-3 pt-4">
                                ...
                                <div>
                                  ...
                                  <ul className="text-xs text-muted-foreground mt-2 space-y-1 list-disc list-inside ml-2">
                                    ...
                                    <li>
                                      Business category and compliance
                                      requirements
                                    </li>
                                    <li>
                                      Transaction volume and merchant agreement
                                    </li>
                                  </ul>
                                </div>
                                ...
                                <div>
                                  ...
                                  <ul className="text-xs text-muted-foreground mt-2 space-y-1 list-disc list-inside ml-2">
                                    ...
                                    <li>
                                      Request access to additional payment
                                      methods
                                    </li>
                                    <li>
                                      Get integration assistance and
                                      documentation
                                    </li>
                                    <li>
                                      Understand pricing and transaction fees
                                    </li>
                                  </ul>
                                </div>
                              </DialogDescription>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {gateway.regions.map((region, idx) => (
                          <Badge
                            key={idx}
                            variant="outline"
                            className="bg-aforeground/5 text-foreground border-border"
                          >
